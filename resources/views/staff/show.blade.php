@extends('layouts.main', ['title' => 'Admin - Show Staff'])
@section('content')
    <!-- Page Wrapper -->
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Information Staff - <span id="myid" name="myid"
                                class="text-info">{{ $staff->workers_id }}</span></h1>
                    ...
                    <div class="container bg-white p-2">
                        <div class="container " style="display: flex">
                            <div class=" p-0 m-0" style="width:80%">
                                <div class=" p-3 ps-0 pb-0">
                                    <div class="col d-flex gap-5">
                                        <div
                                            class="row d-flex flex-column text-start justify-content-start align-items-start">
                                            ...
                                            <div class="col">
                                                <input id="firstname" placeholder="John" type="firstname"
                                                    ...
                                                    name="firstname" required autocomplete="firstname" disabled
                                        ...
                                        <div
                                            ...
                                            <div class="col">
                                                <input id="middlename" placeholder="Dela Cruz" type="text"
                                                    ...
                                                    name="middlename" required autocomplete="middlename" disabled
                                        ...
                                        <div
                                            ...
                                            <div class="col">
                                                <input id="lastname" placeholder="Doe" type="text"
                                                    ...
                                                    name="lastname" required autocomplete="lastname" disabled
                                ...
                                <div class=" p-3 ps-0 pb-0">
                                    <div class="col d-flex gap-5">
                                        <div
                                            ...
                                            <div class="col">
                                                <select disabled id="types" aria-placeholder="Select"
                                                    style="width: 15vw;"class=" form-control @error('types') is-invalid @enderror"
                                                    name="types" autocomplete="types">
                                                    <option value="Select" disabled selected>Select</option>

                                                    @foreach ($types as $type)
                                                        <option @if ($type['types'] == $staff->type) selected @endif
                                                            value="{{ $type['types'] }}">{{ $type['types'] }}
                                                        </option>
                                                    @endforeach
                                        ...
                                        <div
                                            ...
                                            <div class="col">
                                                <input id="number" placeholder="09*******13" type="number"
                                                    ...
                                                    name="number" required autocomplete="number" disabled
                                                    value="{{ $staff->number }}">
                                        ...
                                        <div
                                            ...
                                            <div class="col">
                                                <input id="email" placeholder="Janedoe@gmail.com" type="text"
                                                    ...
                                                    name="email" required autocomplete="email" disabled
                                                    value="{{ $staff->email }}">
                            ...
                            <div class=" p-0 m-0 d-flex justify-content-center align-items-start flex-column"
                                style="width: 20%;">
                                {{ QrCode::size(150)->generate($staff->workers_id) }}
                            </div>
                        </div>
                            ...
                            <div class="row d-flex flex-column text-start justify-content-start align-items-start">
                                ...
                                <div class="col">
                                    <textarea id="address" placeholder="Brgy. Lag On, Daet Camarines Norte " type="text"
                                        ...
                                        cols="100" rows="4" disabled>{{ $staff->address }}</textarea>
