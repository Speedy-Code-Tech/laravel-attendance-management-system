@extends('layouts.main', ['title' => 'Admin - Edit Staff'])
@section('content')
    <!-- Page Wrapper -->
    <div id="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Staff - <span id="myid" name="myid"
                    ...
                    <div class="container bg-white p-2">
                        <form action="{{ route('staff.saveEdit', ['id' => $staff->workers_id]) }}" method="POST">
                            @csrf
                                    ...
                                    <div class="row d-flex flex-column text-start justify-content-start align-items-start">
                                        ...
                                        <div class="col">
                                            <input id="number" placeholder="09*******13" type="number"
                                                ...
                                                required autocomplete="number" value="{{ $staff->number }}">
                                    ...
                                    <div class="row d-flex flex-column text-start justify-content-start align-items-start">
                                        ...
                                        <div class="col">
                                            <input id="email" placeholder="Janedoe@gmail.com" type="text"
                                                ...
                                                required autocomplete="email" value="{{ $staff->email }}">
                                ...
                                <div class="row d-flex flex-column text-start justify-content-start align-items-start">
                                    ...
                                    <div class="col">
                                        <textarea id="address" placeholder="Brgy. Lag On, Daet Camarines Norte " type="text"
                                            ...
                                            cols="100" rows="4">{{ $staff->address }}</textarea>
